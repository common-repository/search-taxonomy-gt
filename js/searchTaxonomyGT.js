jQuery(document).ready(function($){
	if($('.categorydiv').length>0){		
		$('.categorydiv>.tabs-panel').eq(1).prepend('<span class="searchTaxonomyGTdiv"><label for="#searchTaxonomyGT">Search</label><input type="text" value="" id="searchTaxonomyGT"/><br/><input type="checkbox" checked id="searchTaxonomyGT_keephierarchy"/><label for="#searchTaxonomyGT_keephierarchy">Keep Hierarchy</label></span>');
